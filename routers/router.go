...
func init() {
	...
	nsv1 := beego.NewNamespace("/v1",
		...
		beego.NSNamespace("/sys-msg/",
			beego.NSRouter("/my-list", &controllers.SmsController{}, "get:QuerySysMsgs"),
			beego.NSRouter("/read", &controllers.SmsController{}, "post:ReadSysMsg"),
		),
